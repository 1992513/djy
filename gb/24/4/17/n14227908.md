...
<p>独居会带来额外的费用，住房是最明显的支出，但单身人士还需要支付杂货、旅行、交通和娱乐的额外费用。根据麻省理工学院生活工资计算器（MIT Living Wage Calculator）的数据，按照生活必需品的成本推算出各州所需的收入。最后一次数据更新是在2024年2月14日。</p>
